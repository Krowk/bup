...
public class UserServlet extends HttpServlet {
	...
	public static String decrypt(String n) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException,
		...
		byte[] cipherData = Base64.getDecoder().decode(pseudo);
